    ...
    try {
      ...
      if (userDocSnapshot.exists()) {
        ...
        if (!auth.currentUser.emailVerified) {
          if (isVerified != false) {
            // this check should be unnecessary but still good
          ...
          console.log(
            "gotta take you home buddy...we want a module here tho in future"
          );
      ...
      if (error.code === "auth/wrong-password") {
        ...
        setEmail((e) => {
          // Resetting email, you might want to keep the entered email as well
          setPasswordError(true);
        ...
        >
          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              Please verify your email before proceeding. Check your inbox for a
              verification email.
            </DialogContentText>
          </DialogContent>
          <DialogActions>
