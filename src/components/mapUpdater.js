...
//     // const selectedCrop = router.cropType;
//     const { verified, admin, percentType, setCropType, setAdmin, selectedCounty, setSelectedCounty, selectedState, setSelectedState } = useUpdater();
//     console.log("Admin: ", admin);
//     const [countyData, setCountyData] = useState({});
//     const [isUpdating, setIsUpdating] = useState(false);
//     const [userSelectedCounties, setUserSelectedCounties] = useState([]);
...
//     const selectedCrop = setCropType || null;
